...
import com.example.kasir.UserActivity;
...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cursor = db.rawQuery("SELECT * FROM user WHERE nama = '" + getIntent().getStringExtra("nama") + "' LIMIT 1", null);
        cursor.moveToFirst();
        ...
        ton1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (edit.isEmpty()) {
                    ...
                    db.execSQL("update user set nama='" + text2.getText().toString() + "', tgl='" + text3.getText().toString() + "', jk='" + text4.getText().toString() + "', alamat='" + text5.getText().toString() + "' where nomer='" + text1.getText().toString() + "'");
                    Toast.makeText(getApplicationContext(), "Perubahan Tersimpan...", Toast.LENGTH_LONG).show();
                    finish();
                }
                UserActivity.da.RefreshList();
            }
        });
    }
}
